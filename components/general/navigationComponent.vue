<template>
  <div>
    <v-navigation-drawer :value="!mobileMenu" color="primary-gradient" app class="navigation-drawer">
      <template v-slot:prepend>
        <div class="fill-width d-flex justify-center">
          <img src="/logo.svg" width="150px" contain position="center center" class="mt-3">
        </div>
        <v-divider></v-divider>
      </template>
      <v-list>
